...
export async function DELETE(request: NextRequest) {
  ...
  return NextResponse.json({ message: "Permanent doctor deletion is unavailable until appointment and clinical-history dependency checks are deployed. Deactivate the doctor instead." }, { status: 409 });
}
