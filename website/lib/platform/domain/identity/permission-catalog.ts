export const Permissions = {
  ...
  DoctorsRead: "doctors.read", DoctorsCreate: "doctors.create", DoctorsUpdate: "doctors.update", DoctorsDeactivate: "doctors.deactivate", DoctorsAssignServices: "doctors.assign-services",
} as const;
